...
import com.bcopstein.CtrlCorredorV1.Camada2.EstatísticasDTO;
import com.bcopstein.CtrlCorredorV1.Camada2.PerformanceDTO;
import com.bcopstein.CtrlCorredorV1.Camada3.Corredor;
import com.bcopstein.CtrlCorredorV1.Camada3.Evento;
import com.bcopstein.CtrlCorredorV1.Camada3.RepositorioCorredor;
...
public class CtrlCorridasControler {
    ...
    public EstatísticasDTO estatisticas(@RequestParam final int distancia){
        EstatísticasDTO estat = new EstatísticasDTO(this.repositorioEvento,distancia);
        return estat;
    }
    ...
    public PerformanceDTO aumentoPerformance(@RequestParam final int distancia, @RequestParam final int ano){
        PerformanceDTO performanceDTO = new PerformanceDTO(repositorioEvento,distancia,ano);
